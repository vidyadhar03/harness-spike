## Task: notes from a single image
The attachment is one image from the memory dump: a location photo, recce shot, reference still, sketch, mood image, or a photo of written notes.

- doc_type: recce for photos of real places taken for scouting; lookbook for curated reference or mood images; notes for sketches, diagrams, or photos of handwritten or printed notes; unknown otherwise.
